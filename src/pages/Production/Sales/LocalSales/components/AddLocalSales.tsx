...
const AddLocalSales: React.FC = () => {
    ...
    const [all_chalan, setAllChalanNo] = useState<customers[]>([]);
                    ...
                    liElement.addEventListener('click', () => {
                        ...
                        if (clickedValue > 0) {
                            ...
                            function addRow(data: any) {
                                ...
                                input8.type = 'number';
                                input8.name = 'afterDiscountAmount';
                                input8.className = '';
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (dataTable) {
            dataTable.querySelectorAll('tr').forEach((row) => {
                ...
                row.querySelectorAll('td input').forEach((input) => {
                    ...
                    rowData[inputElement.name || 'afterDiscountAmount'] = inputElement.value;
                    ...
                    rowData[inputElement.name || 'tradingType'] = inputElement.value;
        ...
        const GrandDiscount = document.getElementById('discountGrand') as HTMLInputElement;
        const GrandTotal = document.getElementById('totalGrand') as HTMLInputElement;
    ...
    return (
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                <h2 className="text-xl font-bold">Production Local Sales</h2>
            </div>
                            ...
                            <form className="space-y-5">
                                <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input id="browserLname" type="text" placeholder="" className="form-input" onChange={(e) => setCustomerAddress(e.target.value)} />
                                    </div>
                                    <div>
                                        <label htmlFor="browserLname">Sales Date</label>
                                        <input id="browserLname" type="date" placeholder="" className="form-input" onChange={(e) => setSalesDate(e.target.value)} />
                                    </div>
                                    <div>
                                ...
                                <div className="border overflow-hidden overflow-x-auto">
                                    ...
                                    <table className='mt-4'>
                                        ...
                                        <tr className="h-10 border border-black form-input">
                                            ...
                                            <td align="left"><strong id=""><input type='text' id='sdTotal' onChange={(e) => setGrandDiscount(e.target.value)} disabled /></strong></td>
                                        </tr>
                                        <tr className="h-10 border border-black form-input">
                                            <td className="border-r-2 w-3/5" align="right"><strong>Grand Total(BDT)</strong></td>
                                            <td align="left"><strong id=""><input type='text' id='sdTotal' onChange={(e) => setGrandTotal(e.target.value)} disabled /></strong></td>
                                        </tr>
                                    </table>
                                </div>
