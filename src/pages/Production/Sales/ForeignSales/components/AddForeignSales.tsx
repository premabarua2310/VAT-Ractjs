    ...
    return (
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                <h2 className="text-xl font-bold">Production Foreign Sales</h2>
            </div>
                    ...
                    <form className="space-y-5 pt-4">
                        <div className="panel" id="browser_default">
                            <div className="flex items-center justify-between mb-7">
                                <h5 className="font-semibold text-lg dark:text-white-light">Add New Foreign Sales Production</h5>
                            </div>
                            <div className="mb-5">
                                <form className="space-y-5" >
                                    <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
                                        ...
                                        <div>
                                            <label htmlFor="gridState">Country</label>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
                                        ...
                                        <div>
                                            <label htmlFor="browserLname">BOE Item NO</label>
                                            <input id="browserLname" type="text" value={SuppAddress} className="form-input" required />
                                        </div>
                                        <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
                                        ...
                                        <div>
                                            <label htmlFor="browserLname">Vehicle Type</label>
                                            <input id="browserLname" type="text" value={SuppAddress} className="form-input" required />
                                        </div>
                                        <div>
                                    ...
                                    <div className="grid grid-cols-5 gap--x-2 gap-y-3 pb-3">
                                        ...
                                        <input id="userName" placeholder="Enter Add Items" className="form-input py-2.5 text-sm col-span-4" name="user_name" />
                                    </div>
                                    ...
                                    <div className="border overflow-hidden overflow-x-auto ">
                                        ...
                                        <table className='mt-4'>
                                            ...
                                            <tr className="h-10 border border-black form-input">
                                                <td className="border-r-2 w-3/5" align="right"><strong>Total Discount(BDT)</strong></td>
                                                <td align="left"><strong id=""><input type='text' id='sdTotal' onChange={(e) => setTotalSD(e.target.value)} disabled /></strong></td>
                                            </tr>
                                            <tr className="h-10 border border-black form-input">
