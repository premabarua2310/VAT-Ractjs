...
const index = () => {
    ...
    const header = ['Invoice No', 'Cuatomer Name', 'Total Price', 'Invoice Date', 'Action'];
    ...
    return (
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                <h2 className="text-xl font-bold">Foreign Sales Production</h2>
                <div className="flex items-center flex-wrap gap-3">
                    <Link to="/pages/sales/foreign_sales/add" className="btn btn-primary gap-1">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
                ...
                <div className="panel col-span-3 " id="stack_form">
                    <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                        <div className="flex items-center justify-between mb-3">
                            <h5 className="font-semibold text-lg dark:text-white-light">Foreign Sales Production List</h5>
                        </div>
