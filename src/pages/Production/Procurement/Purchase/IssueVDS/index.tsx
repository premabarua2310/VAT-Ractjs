...
const index = () => {
    ...
    const header = ['Serial No', 'Supplier Name', 'VDS No', 'Issue Date', 'Invoice Amount', 'Vat Amount', 'VDS Amount', 'Payment Amount', 'Action'];
                ...
                <div className="panel col-span-3 " id="stack_form">
                    ...
                    <div className="datatables">
                        <DataTable
                            ...
                            records={recordsData}
                            columns={[
                                { accessor: 'debitInvoice', title: 'Serial No', sortable: true },
                                { accessor: 'issueDate', title: 'Supplier Name', sortable: true },
                                { accessor: 'totalAmoun', title: 'VDS No', sortable: true },
                                { accessor: 'totalVat', title: 'Invoice Amount', sortable: true },
                                { accessor: 'totalSd', title: 'Vat Amount', sortable: true },
                                { accessor: 'totalSd', title: 'VDS Amount', sortable: true },
                                { accessor: 'totalSd', title: 'Payment Amount', sortable: true },
                                { accessor: 'musak', title: 'Musak', sortable: true },
                            ]}
