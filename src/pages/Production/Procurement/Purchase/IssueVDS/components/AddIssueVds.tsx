...
const AddIssueVds: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const TotalVDS = document.getElementById('sdTotal') as HTMLInputElement;
        const TotalPayment = document.getElementById('paymentTotal') as HTMLInputElement;


        if (TotalVat || TotalVDS || AllTotal) {
            const Vat = TotalVat.value;
            const SD = TotalVDS.value;
                                ...
                                <div className="border overflow-hidden overflow-x-auto">
                                    ...
                                    <table className='mt-4'>
                                        ...
                                        <tr className="h-10 border border-black form-input">
                                            ...
                                            <td align="left"><strong id=""><input type='text' id='sdTotal' onChange={(e) => setTotalVSD(e.target.value)} disabled /></strong></td>
                                        </tr>
                                        <tr className="h-10 border border-black form-input">
                                            <td className="border-r-2 w-3/5" align="right"><strong>Total Payment(BDT)</strong></td>
                                            <td align="left"><strong id=""><input type='text' id='sdTotal' onChange={(e) => setTotalPayment(e.target.value)} disabled /></strong></td>
                                        </tr>
                                    </table>
                                </div>
