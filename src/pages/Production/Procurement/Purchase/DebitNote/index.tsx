...
const index = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Debit Note Table'));
    });
    ...
    return (
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                <h2 className="text-xl font-bold">Production Debit Note</h2>
                ...
                <div className="panel col-span-3 " id="stack_form">
                    <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                        <div className="flex items-center justify-between mb-3">
                            <h5 className="font-semibold text-lg dark:text-white-light">Production Debit Note List</h5>
                        </div>
                    ...
                    <div className="datatables">
                        <DataTable
                            ...
                            records={recordsData}
                            columns={[
                                { accessor: 'debitInvoice', title: 'Debit Invoice', sortable: true },
                                { accessor: 'issueDate', title: 'Issue Date', sortable: true },
                                { accessor: 'totalAmoun', title: 'Total Amount', sortable: true },
