                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'Inventory' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/pages/inventory/raw_materials">{t('Raw Materials Stock')}</NavLink>
                                        </li>

                                        <li>
                                            <NavLink to="/pages/inventory/finish_goods">{t('Finish Goods Stock')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                                    ...
                                    <ul className="sub-menu text-gray-500">
                                        <li className="menu nav-item">
                                            ...
                                            <AnimateHeight duration={300} height={errorSubMenu ? 'auto' : 0}>
                                                <ul className="sub-menu text-gray-500">
                                                    <li>
                                                        <a href="/pages/production/local_purchase">{t('Local Purchase')}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/pages/production/foreign_purchase">{t('Foregin Purchase')}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/pages/production/service_purchase">{t('Service Purchase')}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/pages/error503">{t('Disposal Unused Item')}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/pages/error404">{t('Debit Note')}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/pages/error404">{t('Issue VDS')}</a>
                                                    </li>
                                                </ul>
                                            </AnimateHeight>
                                        </li>
                                        <li>
                                            <NavLink to="/pages/productionBOM/production_BOM">
                                                {t('Production BOM')}
                                            </NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li className="menu nav-item">
                                            ...
                                            <AnimateHeight duration={300} height={errorSubMenu ? 'auto' : 0}>
                                                <ul className="sub-menu text-gray-500">
                                                    <li>
                                                        <a href="/pages/error404" target="_blank">{t('Local Sales')}</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="/pages/error404" target="_blank">{t('Credit Note')}</a>
                                                    </li>
                                                    <li>
                                                        <a href="/pages/error404" target="_blank">{t('Receive VDS')}</a>
                                                    </li>
                                                </ul>
                                            </AnimateHeight>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'auth' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/pages/Company_Settings">{t('Company Settings')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/dropdown">{t('Authorised Person')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/pages/costing/list">{t('Costing')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/pages/customHouse/custom">{t('Custom-House')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/pages/settings/unit">{t('Unit')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/elements/dropdown">{t('Cpc-Code')}</NavLink>
                                        </li>
                                        <li>
