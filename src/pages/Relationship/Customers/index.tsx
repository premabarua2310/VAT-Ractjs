...
const col = ['serial', 'customerName', 'email', 'phone', 'status', 'action'];
...
const index = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Customers Table'));
    });
    ...
    const header = ['Serial', 'Customer Name', 'Customer Email', 'Customer Phone', 'Status', 'Action'];
        ...
        <div>
            ...
            <div className="panel mt-6">
                <div className="flex items-center justify-between mb-6">
                    <h5 className="font-semibold text-lg dark:text-white-light">Customers List</h5>
                </div>
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'phone', title: 'Customer Phone', sortable: true },
                            {
                                accessor: 'status',
                                title: 'Status',
                                sortable: true,
                            ...
                            },
                            {
                                ...
                                render: ({ serial }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        ...
                                        {/* <NavLink to={"/pages/relationship/customers/edit/" + serial} className="flex btn btn-outline-primary btn-sm m-1 p-2">
                                            <IconEdit className="w-4.5 h-4.5 mr-2" />
                                            Edit
                                        </NavLink> */}
                                    </div>
