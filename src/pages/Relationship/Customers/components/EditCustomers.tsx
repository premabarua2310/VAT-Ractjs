      ...
      <div className="panel mt-6">
        ...
        <div id="forms_grid">
          <div className="flex items-center justify-between mb-5">
            <h3 className="font-semibold text-lg dark:text-white-light">Edit Customer</h3>
          </div>
          <div className="mb-5">
            ...
            <form className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4" id="tagging">
                <div>
                  ...
                  <div>
                    <select className="form-select text-dark " defaultValue="active" name = "shipping_country_id" required >
                ...
                <div>
                  ...
                  <input id="shippingAddress" type="text" placeholder="Enter Address" className="form-input" name = "shipping_address" required />
                </div>
              </div>
